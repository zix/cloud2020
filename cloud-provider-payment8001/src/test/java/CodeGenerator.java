...
public class CodeGenerator {
     ...
     * 数据库名字
     */
    private final static String databaseName = "db2020_cloud";
    /**
     ...
     * 设置父包名
     */
    private final static String parentPackageName = "com.atguigu.springcloud";
    /**
     * 自己的父类实体,没有就不用设置
     */
     ...
     * 是否开启Lombok
     */
    private final static Boolean lombokFlag = false;
    /**
     * 自己的父类控制器,没有就不用设置
     */
    private final static String superControllerClass = "";
    /* 模块名称 */
    private static final String moduleName = "/cloud-provider-payment8001";
